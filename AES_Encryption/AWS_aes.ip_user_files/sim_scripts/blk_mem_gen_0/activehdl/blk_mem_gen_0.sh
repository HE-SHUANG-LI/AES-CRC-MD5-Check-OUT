...
#
# Generated by Vivado on Fri Jul 31 16:15:12 +0800 2020
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="G:/download/AWS_AES加密模块/AWS_aes加密模块/主程序（使用时请避免中文路径）/AWS_aes/AWS_aes.cache/compile_simlib/activehdl"
  fi
